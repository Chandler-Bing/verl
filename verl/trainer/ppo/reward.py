...
def compute_reward(data: DataProto, reward_fn: AbstractRewardManager,step = None,config = None) -> tuple[torch.Tensor, dict[str, Any]]:
    """
    ...
    """
    try:
        reward_result = reward_fn(data, return_dict=True, step=step,config = config)
