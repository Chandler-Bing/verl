...
# Paths
MODEL_PATH=${MODEL_PATH:-"/data/oceanus_share/xinzhimin/exp_outputs/risk0515/DeepSeek-R1-Distill-Qwen-32B/flunt_cot_v3/prompt5_tongzhou0714_5k/2e-5"}
CKPTS_DIR=${CKPTS_DIR:-"/data/oceanus_share/boruipeng/github/${exp_name}"}
TRAIN_FILE=${TRAIN_FILE:-"/data/oceanus_share/xinzhimin/data/risk0515/SFT/flunt_cot_v3/prompt5_0515_12800/RL/train_xgb.parquet"}
TEST_FILE=${TEST_FILE:-"/oceanus-pipline/dataset/prompt_6_1/rl_valid_3k/test/valid_v29_oot09_6k.parquet"}
