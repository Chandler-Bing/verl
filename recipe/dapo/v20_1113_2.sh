...
# Paths
MODEL_PATH=${MODEL_PATH:-"/data/oceanus_share/boruipeng/github/v20_1113/global_step_110/actor_hf"}
...
TEST_FILE=${TEST_FILE:-"/data/oceanus_share/xinzhimin/data/risk0515/SFT_all/base0609/RL/valid_xgb_1113_e2.0.parquet"}
